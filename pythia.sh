...
python run_ref.py EleutherAI/pythia-160m --dataset WikiMIA_length32_paraphrased
python run_ref.py EleutherAI/pythia-160m --dataset WikiMIA_length64_paraphrased
python run_ref.py EleutherAI/pythia-160m --dataset WikiMIA_length128_paraphrased

python run_ref.py EleutherAI/pythia-160m --dataset WikiMIA_length32
python run_ref.py EleutherAI/pythia-160m --dataset WikiMIA_length64
python run_ref.py EleutherAI/pythia-160m --dataset WikiMIA_length128

python run_ref.py EleutherAI/pythia-1b --dataset WikiMIA_length32_paraphrased
python run_ref.py EleutherAI/pythia-1b --dataset WikiMIA_length64_paraphrased
python run_ref.py EleutherAI/pythia-1b --dataset WikiMIA_length128_paraphrased

python run_ref.py EleutherAI/pythia-1b --dataset WikiMIA_length32
python run_ref.py EleutherAI/pythia-1b --dataset WikiMIA_length64
python run_ref.py EleutherAI/pythia-1b --dataset WikiMIA_length128

python run_ref.py EleutherAI/pythia-2.8b --dataset WikiMIA_length32_paraphrased
python run_ref.py EleutherAI/pythia-2.8b --dataset WikiMIA_length64_paraphrased
python run_ref.py EleutherAI/pythia-2.8b --dataset WikiMIA_length128_paraphrased

python run_ref.py EleutherAI/pythia-2.8b --dataset WikiMIA_length32
python run_ref.py EleutherAI/pythia-2.8b --dataset WikiMIA_length64
python run_ref.py EleutherAI/pythia-2.8b --dataset WikiMIA_length128
