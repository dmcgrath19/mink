...
python run_neighbor.py --model EleutherAI/pythia-2.8b --dataset WikiMIA_length64
python run_neighbor.py --model state-spaces/mamba-2.8b-hf --dataset WikiMIA_length64
python run_neighbor.py --model state-spaces/mamba-2.8b-hf --dataset WikiMIA_length64
